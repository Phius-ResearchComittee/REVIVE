...
def SimulationOutputs(idf):
    ...
    outputVars = ['Site Outdoor Air Drybulb Temperature', 'Zone Air Relative Humidity', 'Zone Air CO2 Concentration', 'Zone Air Temperature', 'Zone Mean Radiant Temperature', 
                ...
                'Site Outdoor Air Dewpoint Temperature', 'Zone Mean Air Dewpoint Temperature','Facility Total Surplus Electricity Energy', 'Site Horizontal Infrared Radiation Rate per Area',
                'Site Diffuse Solar Radiation Rate per Area', 'Site Direct Solar Radiation Rate per Area', 'Site Total Sky Cover', 'Zone Thermal Comfort Pierce Model Standard Effective Temperature']
